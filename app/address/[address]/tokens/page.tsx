...
export async function generateMetadata(props: AddressPageMetadataProps): Promise<Metadata> {
    return {
        description: `All tokens owned by the address ${props.params.address} on ${explorerNetworkDescriptionName()}`,
        title: `Tokens | ${await getReadableTitleFromAddress(props)} | ${explorerNetworkName()}`,
    };
}
